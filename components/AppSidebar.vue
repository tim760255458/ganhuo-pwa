            ...
            <div v-if="blocks" class="app-sidebar-blocks">
                <ul>
                    ...
                    <li v-for="(block, index) in blocks" :key="index" class="app-sidebar-block">
                        ...
                        <div v-ripple="true" v-else @click.stop="closeAndGo(block.route)" class="app-sidebar-block-item sub-list-title">
                            <span v-if="block.icon || block.image" class="app-sidebar-block-left-icon">
                                <img v-if="block.image" :src="block.image" :alt="block.alt"></img>
                                <v-icon v-else-if="block.icon">{{ block.icon }}</v-icon>
                            </span>
                            <span v-if="block.text" class="app-sidebar-block-text">{{ block.text }}</span>
                        </div>
                    </li>
                </ul>
            </div>
